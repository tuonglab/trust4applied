...
while IFS= read -r -d '' file; do
    ...
    awk -F '\t' 'NR==1 || (substr($5,1,3)=="TRB" && substr($7,1,3)=="TRB" && substr($14,1,1)=="C" && (substr($14,length($14),1)=="F" || substr($14,length($14),1)=="W")) {print $1,$4,$5,$7,$13,$14,$21,$22}' OFS='\t' "$file" > "${file%.tsv}_extracted.tsv"
